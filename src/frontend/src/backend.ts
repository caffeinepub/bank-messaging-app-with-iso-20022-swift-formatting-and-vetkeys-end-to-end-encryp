...
export class Backend implements backendInterface {
    ...
    async addTrustedContact(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTrustedContact(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMessagesForCaller(): Promise<Array<EncryptedMessage>> {
        if (this.processError) {
            try {
    ...
    async getTrustedContacts(): Promise<Array<Principal>> {
        if (this.processError) {
            try {
    ...
    async isTrustedContact(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isTrustedContact(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeTrustedContact(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: Principal, arg1: MessageType, arg2: Uint8Array, arg3: EncryptedKeyBytes): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_EncryptedMessage_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EncryptedMessage): EncryptedMessage {
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        publicKey: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.publicKey)),
        name: value.name
    };
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    timestamp: _Time;
    encryptedPayload: Uint8Array;
    encryptedSymmetricKey: _EncryptedKeyBytes;
}): {
    id: bigint;
    to: Principal;
    from: Principal;
    ...
    return {
        ...
        to: value.to,
        from: value.from,
        messageType: from_candid_MessageType_n6(_uploadFile, _downloadFile, value.messageType),
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "iso20022" in value ? MessageType.iso20022 : "swift" in value ? MessageType.swift : value;
}
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_EncryptedMessage>): Array<EncryptedMessage> {
    return value.map((x)=>from_candid_EncryptedMessage_n4(_uploadFile, _downloadFile, x));
}
function to_candid_MessageType_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageType): _MessageType {
...
function to_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        publicKey: value.publicKey ? candid_some(value.publicKey) : candid_none(),
        name: value.name
    };
}
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageType): {
    iso20022: null;
} | {
    swift: null;
} {
    return value == MessageType.iso20022 ? {
        iso20022: null
    } : value == MessageType.swift ? {
        swift: null
    } : value;
}
