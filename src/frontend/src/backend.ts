...
import type { Message as _Message, MessageType as _MessageType, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, VetKeyBytes as _VetKeyBytes } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async sendMessage(arg0: Principal, arg1: MessageType, arg2: Uint8Array, arg3: VetKeyBytes): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_MessageType_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MessageType): MessageType {
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        to: value.to,
        from: value.from,
        messageType: from_candid_MessageType_n12(_uploadFile, _downloadFile, value.messageType),
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        publicKey: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.publicKey)),
        name: value.name
    };
}
