      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="space-y-1">
            ...
            <Badge
              variant={callerHasPublicKey ? "default" : "secondary"}
              className="text-xs"
            >
          ...
          <div className="space-y-1">
            <p className="text-xs text-muted-foreground">
              Recipient Public Key Registered
            </p>
            <Badge
              variant={otherHasPublicKey ? "default" : "secondary"}
              className="text-xs"
            >
          ...
          <div className="space-y-1">
            ...
            <Badge
              variant={isMutuallyTrusted ? "default" : "secondary"}
              className="text-xs"
            >
          ...
          <div className="space-y-1">
            ...
            <Badge
              variant={vetKeyPresent ? "default" : "secondary"}
              className="text-xs"
            >
