    ...
    <Card className="border-dashed">
      <CardHeader>
        ...
        <CardDescription className="text-xs">
          Verify mainnet ledger IDs and connectivity without performing
          transfers
        </CardDescription>
      </CardHeader>
                            ...
                            <div className="space-y-1 bg-muted/50 p-2 rounded">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                  {token.metadataCheck.metadata.name}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-muted-foreground">
                                ...
                                <span className="font-medium">
                                  {token.metadataCheck.metadata.symbol}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-muted-foreground">
                                ...
                                <span className="font-medium">
                                  {token.metadataCheck.metadata.decimals}
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-muted-foreground">
        ...
        <div className="flex gap-2 p-3 bg-muted/50 rounded-md">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              This diagnostic performs only read-only metadata queries. No token
              transfers are executed during this check.
            </p>
          </div>
        </div>
      </CardContent>
